...
function randomspruch ()
    zahl = math.random(1,5)
    if tonumber(zahl) == 1 then
        spruch = "Join now"
    elseif tonumber(zahl) == 2 then
        spruch = "1999"
    elseif tonumber(zahl) == 3 then
        spruch = "6.50€"
    elseif tonumber(zahl) == 4 then
        spruch = "Maggi!"
    elseif tonumber(zahl) == 5 then
        spruch = "BANANA!"
    elseif tonumber(zahl) == 6 then
        spruch = forumURL
    elseif tonumber(zahl) == 7 then
        spruch = "SPARTA!"
    end
